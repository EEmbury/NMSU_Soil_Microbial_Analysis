...
# However, it is recommended that users utilize the default value of B, 
# which is 100, or larger values for optimal performance.
output_month = ancombc2(data = tse, assay_name = "counts", tax_level = "Order",
...
bias_correct_log_table = output_month$bias_correct_log_table
...
fig_pair = df_fig_pair %>%
    ...
    scale_fill_gradient2(low = "#4ba3c3", high = "#ba324f", mid = "lightgrey", 
                         na.value = "black", midpoint = 0, limit = c(lo, up),
                         name = NULL) +
    geom_text(aes(group, taxon, label = value, color = color), size = 4) +
    scale_color_identity(guide = FALSE) +
    labs(x = NULL, y = NULL, title = "Pairwise log-fold changes: Fungi") +
    theme_minimal() +
    theme(plot.title = element_text(hjust = 0.5))
fig_pair

#ggsave(file="~/Desktop/Master_Data/Masters_R/NMSU_Soil_Microbial_Analysis/images/fun_daa_2_color_change.png", device = png, plot=fig_pair, width=7, height=5)
