...
funguild_taxa <- read.csv("~/Desktop/Master_Data/Masters_R/NMSU_Soil_Microbial_Analysis/Fungi/FunGuild.guilds_matched.csv", header = TRUE)

#merge funguild data with phyloseq

psMelt <- psmelt(phylo_rm_cntrl)

psMelt$OTU_ID <- psMelt$OTU

funguild <- merge(psMelt,funguild_taxa,by="OTU_ID")
