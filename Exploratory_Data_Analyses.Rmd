...
```{r}
PLFA_fun_bac <- read.csv("Raw_data/All_PLFA_fun_back.csv")
...
PLFA_fun_bac$interaction2 <- factor(interaction(PLFA_fun_bac$Type, PLFA_fun_bac$Month),
                                   levels = c("Bacteria.October","Bacteria.March",
                                              "Bacteria.January", "Bacteria.May", "Bacteria.July",
                                              "Fungi.October","Fungi.March",
                                              "Fungi.January", "Fungi.May", "Fungi.July"))
...
PLFA_plot + scale_x_discrete(labels=c( "Bacteria.October" = " ", "Bacteria.March" = "", "Bacteria.January" = "Bacteria",
                            "Bacteria.May" = "", "Bacteria.July" = "",
                              "Fungi.October" = "", "Fungi.March" = "", "Fungi.January" = "Fungi",
                            "Fungi.May" = "", "Fungi.July" = "")) 

mod.plfa <- aov(PLFA_fun_bac$Total_Percent_Biomass ~ PLFA_fun_bac$Type*PLFA_fun_bac$Month)
summary(mod.plfa)

tuk.plfa <- TukeyHSD(mod.plfa)

### filter TukeyHSD results to only show significant values
as.data.frame(tuk.plfa$`PLFA_fun_bac$Type:PLFA_fun_bac$Month`) %>%
  filter(`p adj` < .05)
...
PLFA_total <- read.csv("Raw_data/Total_biomass.csv")
