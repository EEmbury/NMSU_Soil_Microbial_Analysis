...
g1
#ggsave("soil_amp_node_overlap_Bacteria2.png", g1, width = 7, height = 6)
...
g1 <- tmp1$plot_venn(fill_color = FALSE, color = c("#679436", "#c1292e", "#e1bc29"))
g1
#ggsave("soil_amp_edge_overlap_bacteria2.png", g1, width = 7, height = 6)
...
g1
#ggsave("soil_amp_edge_tax_comp_bacteria2.pdf", g1, width = 7, height = 7)



### plots ###
# plots are exported from R and built using Gephi

# soil_amp_network$Grass$save_network(filepath = "bacteria_grass_network2.gexf")
# soil_amp_network$Mesquite$save_network(filepath = "bacteria_mesquite_network2.gexf")
# soil_amp_network$GrassMesquite$save_network(filepath = "bacteria_grassmesquite_network2.gexf")
...
* The following code are various attempts that were not utilized in the final publication
```{r}
