...
#subset to grass
grass_ps <- subset_samples(rel, vegetation=="Grass")
# #subset to grass_mesquite
grass_mesquite_ps <- subset_samples(rel, vegetation=="Mesquite_grass")
# #subset to mesquite
mesquite_ps <- subset_samples(rel, vegetation=="Mesquite")

## cross-network analysis?
rel_meco <- file2meco::phyloseq2meco(rel)
...
tmp$cal_network(network_method = "SpiecEasi", SpiecEasi_method = "mb")
...
soil_amp_network_edgetax <- edge_tax_comp(soil_amp_network, taxrank = "Class", label = "+", rel = TRUE)
