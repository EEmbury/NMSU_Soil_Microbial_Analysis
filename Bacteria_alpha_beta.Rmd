...
alpha_veg <- plot_richness(phylo, x = "vegetation")
alpha_veg
...
anova.sh.mo = aov(richness$Shannon ~ sample_data(phylo)$month)
summary(anova.sh.mo)

TukeyHSD(anova.sh.mo)
...
adon <- adonis(DistBC ~ vegetation, data = sampleDF)

library(pairwiseAdonis)
pairwise.adonis(DistBC, phyloseq::sample_data(phylo)$vegetation)

# betadisper - analysis of multivariate homogeneity of group dispersions (variances)
