...
mapping_file$Vegetation <- factor(mapping_file$vegetation, levels = c("Grass", "Mesquite_grass", "Mesquite"), 
                  labels = c("Grass", "Grass-Mesquite", "Mesquite")) 

mapping_file$Month <- factor(mapping_file$month, levels = c("Oct", "Jan", "Mar", "May", "Jul"), 
                  labels = c("October", "January", "March", "May", "July"))

mapping_file$month_veg = paste(mapping_file$Month, mapping_file$Vegetation, sep="-")
...
#plot distances
p <- plot_ordination(rare, ordBC, color = "Vegetation") + 
