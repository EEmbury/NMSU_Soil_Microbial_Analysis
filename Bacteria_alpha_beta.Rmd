...
bac_alpha <- alpha_mo_sh + 
  ...
  ggtitle ("Bacterial Alpha Diversity")+  #change title
...
#library(svglite)
#ggsave(file="~/Desktop/Master_Data/Masters_R/NMSU_Soil_Microbial_Analysis/images/bac_beta.png", plot=p, width=7, height=5)
