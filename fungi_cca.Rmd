...
aov <- anova(mod_all, by="term", permutations=999)
aov

write.table(aov, file = "~/Desktop/Master_Data/Masters_R/NMSU_Soil_Microbial_Analysis/Fungi/fungi_cca_aov.txt", sep = ",", quote = FALSE, row.names = T)
