...
metadata$veg_abrev <- factor(metadata$vegetation, levels = c("Grass", "Mesquite-Grass", "Mesquite"), 
                  labels = c("M", "T", "G"))
...
CN_plot_veg <- ggplot(metadata, aes(x=vegetation, #change order of x-axis
  ...
  xlab("Vegetation") + # change x axis label
  ylab("Carbon to Nitrogen")+ # change y axis label
 scale_fill_manual(values=c("Mesquite" ="#c1292e", "Mesquite-Grass" = "#e1bc29", "Grass" = "#679436"))+
